            ...
            <ul class="sidebar-menu menu tree" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu" style="display: none;">
                        <li><a class="link" href="#" data-link=""><i class="fa fa-fw fa-cubes"></i>Parametros</a></li>
                        <li><a class="link" href="#" data-link=""><i class="fa fa-fw fa-cubes"></i>Depositos</a></li>
                        <li><a class="link" href="#" data-link=""><i class="fa fa-fw fa-cubes"></i>Proveedores</a></li>
                    </ul>
                </li>
            </ul>
        </section>
