            ...
            <tbody>
                <?php
                    foreach ($list as $o) {
                        ...
                        echo '<i class="fa fa-fw  fa-battery text-light-blue btn-estado" style="cursor: pointer;" title="Estado Pedido"></i> ';
                        echo '</td>';
...
<?php
    $this->load->view('almacen/new/pedidos_materiales/estado_pedido');            
?>