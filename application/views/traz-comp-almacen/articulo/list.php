...
function LoadArt(id_, action) {
    ...
    $.ajax({
        ...
        url: '<?php echo base_url(CMP_ALM) ?>Articulo/getArticle',
...
$('#btnSave').click(function() {
    ...
    $.ajax({
        ...
        url: '<?php echo base_url(CMP_ALM) ?>Articulo/setArticle',
        success: function(result) {
...
$(".fa-pencil").click(function(e) { // Ok
    ...
    $.ajax({
        ...
        dataType: 'json',
        type: 'POST',
        url: '<?php echo base_url(CMP_ALM) ?>Articulo/getpencil',
...
function guardareditar() { // Ok
    ...
    $.ajax({
        ...
        url: '<?php echo base_url(CMP_ALM) ?>Articulo/editar_art',
        success: function(data) {
            linkTo();
        },
        error: function(result) {
...
function eliminar_articulo() {
    ...
    $.ajax({
        ...
        url: '<?php echo base_url(CMP_ALM) ?>Articulo/baja_articulo', //index.php/
        success: function(data) {
