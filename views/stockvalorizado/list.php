    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Stock Valorizado</h3>
            </div><!-- /.box-header -->
...
<script>
    $("#cargar_tabla").load("<?php echo base_url(ALM) ?>Stockvalorizado/Listar_tabla");
...
function filtrar() {
    ...
    var url1 = "<?php echo base_url(ALM) ?>Stockvalorizado/filtrarListado?depositodescrip="+depositodescrip+"&fec_desde="+fec_desde+"&fec_hasta="+fec_hasta+"&establecimiento="+establecimiento+"&tipo_deposito="+tipo_deposito;
    $("#cargar_tabla").load(url1,() => {
        if(_isset(depositodescrip)){
            tabla = $('#stockValorizado').DataTable();
        }
        jsRemoveWindowLoad();
    });
}
