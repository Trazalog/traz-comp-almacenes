    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label>Lote:</label>
                    <select class="form-control select2 select2-hidden-accesible" id="loteent" name="loteent" required disabled>
                        <option value="" disabled selected>-Seleccione opción-</option>
                    </select>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input name="cantidadent" class="form-control inp-descarga" type="number" id="cantidadent" min="0" disabled onchange="if(this.value < 0) { Swal.fire({title: 'Error', text: 'Ingrese un numero mayor a 0', type: 'error', confirmButtonText: 'Aceptar'}); this.value = 0; }">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
