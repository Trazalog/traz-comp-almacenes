    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="#" class="logo" onclick="linkTo();">
                ...
                <span class="logo-lg"><b>Tools-T</b> Almacen</span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                <ul class="sidebar-menu menu tree" data-widget="tree">
                    ...
                    <li><a class="link" href="#" data-link="<?php echo CMP_ALM?>Proceso"><i class="fa fa-list"></i>Mis
                            Tareas</a></li>
                    ...
                    <li><a class="link" href="#" data-link="<?php echo CMP_ALM?>new/Entrega_Material"><i
                                class="fa fa-fw fa-check"></i>Entrega Materiales</a></li>
                    <li><a class="link" href="#" data-link="<?php echo CMP_ALM?>Remito"><i
                                class="fa fa-fw fa-truck"></i>Recepcion Materiales</a></li>
                    <li><a class="link" href="#" data-link="<?php echo CMP_ALM?>Lote/puntoPedList"><i
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu" style="display: none;">
                            <li><a class="link" href="#" data-link=""><i class="fa fa-fw fa-cubes"></i>Parametros</a>
                            </li>
                            <li><a class="link" href="#" data-link=""><i class="fa fa-fw fa-cubes"></i>Depositos</a>
                            </li>
                            <li><a class="link" href="#" data-link=""><i class="fa fa-fw fa-cubes"></i>Proveedores</a>
                            </li>
                        </ul>
                    </li>
                </ul>
